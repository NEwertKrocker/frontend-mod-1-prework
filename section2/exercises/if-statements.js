...
if (dogAge <= 2) {
  ...
  console.log("An elderly dog.")
} else {
  console.log("An adult dog.")
}
...
I was able to use a logical operator in the pizza example, but I'm having a hard time
envisioning how a logical operator might have made my gumball example sleeker! Any advice?
