...
var seaCreatures = ["Octopus", "Baleen Whale", "Shark", "Sea Serpent"];

for (var i = 0; i < seaCreatures.length; i++) {
  console.log("The " + seaCreatures[i] + " is awesome!");
}

// YOU DO: Create an array of foods and then iterate over that array to log "Add
// <food> to shopping list" for each food item.
var groceryNeeds = ["yogurt", "celery", "peanut butter", "melon"];

for (var i = 0; i < groceryNeeds.length; i++) {
  console.log("Add " + groceryNeeds[i] + " to shopping list");
}

// YOU DO: Create an array of numbers and then iterate over that array to log double
// of each of the number. (Ex: 4 doubled is 8.)
var number = [2, 5, 22, 380];
