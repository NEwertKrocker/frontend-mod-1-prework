...
/* I believe that, just like with concatenation, type coercion will mean that the whole bit
...
var favGame = "Secret of Mana";
var gameConsole = "SNES";
var timesBeaten = 7;
console.log(`My favorite game of all time is ${favGame} for the ${gameConsole}. I've beaten it ${timesBeaten} times!`)
