...
/* The variable 'firstName' should be a String, because it's going to be represented by text (a name).
'isHungry' seems pretty clearly to be a binary choice, yes/no, so it should be a Boolean.
numberOfPets, of course, is going to be a Number. */
